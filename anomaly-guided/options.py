...
class Configs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--save_name", type=str, default="att_orig_gan_v9", help="Path or url of the dataset")
        ...
        self.parser.add_argument("--check_point", type=str, default="outputs/resc_512/att_orig_gan_v9", help="Path of the pre-trained Network")
        ...
        self.parser.add_argument("--out_cam_pred_alpha", type=int, default=0.77, help="bg score") # # 0.7 resc 0.8 duke 0.7 ours
