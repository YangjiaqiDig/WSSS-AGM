...
from utils.utils import CAT_LIST, OrgLabels, convert_duke_labels, convert_our_dataset_labels, convert_resc_labels, get_num_classes
...
if __name__ == '__main__':
    ...
    parser.add_argument("--predict_dir", default='/scr2/xhu/jiaqi/wsss/anomaly-guided/outputs/resc_512/tieqiao_resc/cams', type=str)
    parser.add_argument("--gt_dir", default='/scr2/xhu/jiaqi/wsss/anomaly-guided/datasets/RESC/valid/label_images', type=str)
    parser.add_argument('--dataset_type', default="resc", type=str, choices=['duke', 'resc', 'nyu'])
    ...
    name_list = [pth.split('/')[-1].replace('.npy', '') for pth in glob.glob(args.predict_dir + '/*')]
    # import pdb; pdb.set_trace()
