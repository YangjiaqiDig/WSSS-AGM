...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--nz', type=int, default=120, help='size of the latent z vector')
        ...
        self.parser.add_argument('--metric', type=str, default='roc', help='Evaluation metric. auprc | roc | f1_score')
        ...
        self.parser.add_argument('--w_enc', type=float, default=0.1, help='Encoder loss weight.')
        self.isTrain = True
        self.opt = None
