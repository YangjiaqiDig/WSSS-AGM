...
class Configs():
    ...
    def __init__(self):
        ...
        '''Dataset params'''
        self.parser.add_argument("--root_dirs", type=str, default="/scr2/xhu/jiaqi/wsss/datasets/RESC", help="root datasets directory: 2015_BOE_Chiu | RESC | our_dataset")
        self.parser.add_argument("--save_name", type=str, default="att_orig_gan_v9_rep", help="Path or url of the dataset")
        ...
        self.parser.add_argument("--aug_smooth", type=bool, default=True, help="If make grad-cam aug smooth")
        self.parser.add_argument("--num_heads", type=int, default=4, help="Attention heads number")    
        self.parser.add_argument("--backbone", type=str, default="resnet50", help="resnet18, resnet50, resnet101, vgg16, densenet, mnasnet")
        self.parser.add_argument("--retinal_model", type=str, default="AGM", help="AGM | CNNs | Transformers")
        ...
        self.parser.add_argument("--reg_epochs", type=int, default=0, help="Number of training epochs")
        self.parser.add_argument("--iter_epochs", type=int, default=5, help="Number of iterations for refine CAM")
        ...
        self.parser.add_argument("--lr", type=float, default=0.0001, help="Classification Learning rate") # 0.001 # 0.0001 ref # 0.000015
        ...
        self.parser.add_argument("--check_point", type=str, default="outputs/resc_512/att_orig_gan_v9_rep", help="Path of the pre-trained Network")
        self.parser.add_argument("--ckp_epoch", type=str, default="best_iou", help="best, last, best_iou") # ours (v2) iter_39 , duke iter_27 or iter_21?, resc 17
        self.parser.add_argument("--continue_train", type=bool, default=True, help="Continue train")
        self.parser.add_argument("--out_cam_pred_alpha", type=int, default=0.7, help="bg score") # # 0.77 resc 0.8 duke 0.7 ours
    ...
    def parse(self, is_inference=False):
        ...
        if 'RESC' in args.root_dirs:
            ...
            args.mask_dir = f"{args.root_dirs}/mask"
