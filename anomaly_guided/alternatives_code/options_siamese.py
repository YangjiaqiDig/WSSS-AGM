...
class Configs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--save_name", type=str, default="dual_13", help="Path or url of the dataset")
        ...
        self.parser.add_argument("--save_cam_images", type=bool, default=True, help="Save the results in save folder or not")
        ...
        self.parser.add_argument("--num_heads", type=int, default=4, help="Attention heads number")    
        self.parser.add_argument("--backbone", type=str, default="resnet50", help="resnet18, resnet50, resnet101, vgg16")
        self.parser.add_argument("--retinal_model", type=str, default="AAM", help="AAM | CNNs | Transformers")
        ...
        '''Trainning params'''
        self.parser.add_argument("--w_cls", type=float, default=1, help="Cross Entropy loss weight")
        self.parser.add_argument("--w_eq", type=float, default=0, help="Cross Entropy loss weight")
        self.parser.add_argument("--w_miou", type=float, default=0, help="Cross Entropy loss weight")
        self.parser.add_argument("--w_recon", type=float, default=0, help="Cross Entropy loss weight")
        self.parser.add_argument("--epochs", type=int, default=40, help="Number of training epochs")
        ...
        self.parser.add_argument("--lr_schedule", type=dict, default={'step': 5000000, 'gamma': 0.1}, help="Learning rate decay step and gamma")
        ...
        self.parser.add_argument("--check_point", type=str, default="outputs_dual/duke/att_orig_gan_v1", help="Path of the pre-trained Network")
        self.parser.add_argument("--ckp_epoch", type=str, default="iter_21", help="best, last, best_iou") # ours iter_39     
        ...
        self.parser.add_argument("--save_inference", type=str, default='outputs_dual', help="Save inference or test images directory")
    ...
    def parse(self, is_inference=False):
        ...
        if 'RESC' in args.root_dirs:
            ...
            args.save_folder = 'outputs_dual/resc/' + args.save_name
        elif 'BOE' in args.root_dirs:
            args.annot_dir = "segment_annotation/labels"
            args.save_folder = 'outputs_dual/duke/' + args.save_name
        else:
            ...
            args.save_folder = 'outputs_dual/our_dataset/' + args.expert_annot  + '_' +  args.save_name
        ...
        if args.continue_train:
            ...
            if args.seg_epochs > 0:
                save_opt_name  = 'opt_seg.txt'
            else: save_opt_name = 'opt_continue.txt'
