...
class MultiClassModel(nn.Module):
    def __init__(self, backbone, num_class, num_input_channel=3):
        super().__init__()
        ...
        self.base_model.avgpool = nn.MaxPool2d(kernel_size=7, stride=7, padding=0)
