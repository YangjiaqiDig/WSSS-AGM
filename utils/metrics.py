...
from utils import CAT_LIST, OrgLabels, convert_duke_labels, convert_our_dataset_labels, convert_resc_labels, get_num_classes
...
def assd_score(y_target, y_pred, n_class):
    return assd(y_target, y_pred)
