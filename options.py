...
class Configs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--save_folder", type=str, default="outputs/resc_512/origin_gan_postatt", help="Path or url of the dataset")
        ...
        self.parser.add_argument("--check_point", type=str, default="outputs/resc_512/origin_gan_att", help="Path of the pre-trained Network")
