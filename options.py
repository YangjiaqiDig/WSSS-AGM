...
class Configs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--save_folder", type=str, default="outputs/both_orig_bgl", help="Path or url of the dataset")
        ...
        self.parser.add_argument("--w_dice", type=float, default=1, help="Dice loss weight")
        ...
        self.parser.add_argument("--check_point", type=str, default="outputs/aug_orig_gan_bgl", help="Path of the pre-trained Network")
