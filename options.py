...
class Configs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--save_folder", type=str, default="outputs/resc_512/att_orig_gan_v13", help="Path or url of the dataset")
        ...
        self.parser.add_argument("--segmentation", type=int, default=500, help="The number of epoch that starts segmentation branch")
        ...
        self.parser.add_argument("--lr", type=float, default=0.0001, help="Learning rate") #0.001
        self.parser.add_argument("--lr_schedule", type=dict, default={'step': 150, 'gamma': 0.5}, help="Learning rate decay step and gamma")
        ...
        self.parser.add_argument("--ckp_epoch", type=str, default="best", help="best, last")        
