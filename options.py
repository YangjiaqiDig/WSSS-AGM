...
class Configs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--save_folder", type=str, default="outputs/dice_orig_gan_bgl",
        ...
        self.parser.add_argument("--n_epochs", type=int, default=100, #25
                            help="Number of training epochs")
        self.parser.add_argument("--refine_epoch_point", type=int, default=35, 
